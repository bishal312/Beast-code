        ...
        <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-3'>
            {
                ...
                <div className='p-6'>
                    <div className='relative mb-4 h-48 w-full overflow-hidden rounded-xl'>
                        <Image fill className="object-cover" src={article.featuredImage} alt="woman reading article" />
                    </div>
                    {/* <ArticleContent/> */}
...
const NoSearchResults = () => {
    return (
        <div className='flex flex-col items-center justify-center p-8 text-clip'>
